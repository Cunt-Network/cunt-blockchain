...
required to run a [Timelord](https://github.com/Cunt-Network/cunt-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Cunt-Network/cunt-blockchain/blob/main/install-timelord.sh)

...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Cunt-darwin-arm64/Cunt.app --platform=darwin \
...
mv Cunt-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Cunt-$CUNT_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Cunt-darwin-arm64/Cunt.app Cunt-$CUNT_INSTALLER_VERSION-arm64 \

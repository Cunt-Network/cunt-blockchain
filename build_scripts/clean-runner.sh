...
rm -rf ../venv || true
rm -rf venv || true
rm -rf cunt_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf cunt-blockchain-gui/build || true
rm -rf cunt-blockchain-gui/daemon || true
rm -rf cunt-blockchain-gui/node_modules || true
rm cunt-blockchain-gui/temp.json || true
( cd "$PWD/cunt-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @cunt-network/notarize-cli || true

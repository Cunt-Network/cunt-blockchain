...
# Gets the version from the result of "cunt version"
...
def get_cunt_version() -> str:
    version: str = "0.0"
    output = subprocess.run(["cunt", "version"], capture_output=True)
...
if __name__ == "__main__":
    update_version(f"{os.path.dirname(__file__)}/cunt-blockchain-gui/package.json")
    update_version(f"{os.path.dirname(__file__)}/cunt-blockchain-gui/packages/gui/package.json")

...
If you want to learn more about this project, read the [wiki](https://github.com/Cunt-Network/cunt-blockchain/wiki), or check out the [green paper](https://www.cuntnetwork.net/assets/CuntGreenPaper.pdf).

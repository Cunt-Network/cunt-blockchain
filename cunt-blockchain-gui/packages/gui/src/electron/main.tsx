...
import AppIcon from '../assets/img/cunt64x64.png';
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Cunt-Network/cunt-blockchain/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://twitter.com/CuntNetwork');
            },
          },
        ],
      },

...
import { Flex, UnitFormat, More, Table, mojoToCuntLocaleString, Suspender } from '@cunt/core';
...
import { WalletStatus } from '@cunt/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToCuntLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }

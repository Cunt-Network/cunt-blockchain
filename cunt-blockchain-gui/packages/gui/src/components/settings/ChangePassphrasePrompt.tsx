...
import { AlertDialog, Flex, useOpenDialog, Suspender, useValidateChangePassphraseParams } from '@cunt/core';
import { useGetKeyringStatusQuery, useRemoveKeyringPassphraseMutation, useSetKeyringPassphraseMutation } from '@cunt/api-react';
      ...
      <DialogContent>
        ...
        {!!canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. Cunt will be able to access your keys without prompting for your passphrase.`}>

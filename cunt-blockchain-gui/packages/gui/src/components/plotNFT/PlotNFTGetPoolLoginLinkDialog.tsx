...
import { CopyToClipboard, Flex, Link, Loading } from '@cunt/core';
import {
  Button,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@cunt/api-react';
import type { PlotNFT, PlotNFTExternal } from '@cunt/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/Cunt-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >

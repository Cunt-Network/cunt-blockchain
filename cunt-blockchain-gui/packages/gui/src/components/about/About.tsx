...
import icon from '../../assets/img/cunt_circle.svg';
...
const url = 'https://cuntnetwork.org';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} Cunt Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Cunt-Network/cunt-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>

...
import { defaultPlotter } from '@cunt/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@cunt/api-react';
import { ChevronRight as ChevronRightIcon } from '@material-ui/icons';
import { useForm, SubmitHandler } from 'react-hook-form';
import { useShowError, ButtonLoading, Flex, Form, FormBackButton, toBech32m } from '@cunt/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.CUNTPOS),
  });

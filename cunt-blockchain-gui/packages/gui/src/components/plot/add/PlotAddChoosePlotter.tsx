...
import { CardStep, Select, StateColor } from '@cunt/core';
import { useGetPlottersQuery } from '@cunt/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@cunt/api';
import type { Plotter, PlotterMap } from '@cunt/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.CUNTPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Cunt Proof of Space plotter. If unsure,
            use the default Cunt Proof of Space plotter.
        </Trans>
      </Typography>

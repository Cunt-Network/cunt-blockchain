...
import { Link, Loading, Table, Card, FormatBytes } from '@cunt/core';
import { useGetFarmingInfoQuery } from '@cunt/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/Cunt-Network/cunt-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>

...
import { useGetWalletBalanceQuery, useGetWalletsQuery } from '@cunt/api-react';
import { Wallet, WalletType } from '@cunt/api';
    ...
    if (!isLoading && tradeSide === 'sell' && walletBalance && walletBalance.walletId == row.assetWalletId) {
      switch (item.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToCuntLocaleString(walletBalance.spendableBalance);
          balance = mojoToCunt(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:

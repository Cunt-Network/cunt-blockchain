...
import { cuntToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@cunt/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = cuntToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Cunt Asset Token Wallet</Trans>
        </Back>
        <Card>

...
import { useGetWalletBalanceQuery } from '@cunt/api-react';
import { TransactionType } from '@cunt/api';
import type { Transaction } from '@cunt/api';
import { mojoToCunt, blockHeightToTimestamp } from '@cunt/core';
  ...
  const points = [
    {
      ...
      y: Math.max(0, Number(mojoToCunt(start))),
      tooltip: mojoToCunt(balance),
    },
  ];

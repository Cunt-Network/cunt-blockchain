...
import cuntToMojo from '../../utils/cuntToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isCuntCurrency = ['VAG', 'TVAG'].includes(currencyCode);
  const mojo = isCuntCurrency 
    ? cuntToMojo(correctedValue) 
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isCuntCurrency ? 12 : 3,
          },
          endAdornment: (

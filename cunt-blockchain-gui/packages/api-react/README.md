...
This library provides react hooks on the top of @cunt/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Cunt Blockchain).
...
import { useGetPublicKeysQuery } from '@cunt/api-react';
...
import { store, api } from '@cunt/api-react';

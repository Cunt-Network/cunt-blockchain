...
This library provides support for TypeScript/JavaScript [Cunt](https://www.cuntnetwork.org) apps to access the [Cunt Blockchain RPC](https://github.com/Cunt-Network/cunt-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Cunt Blockchain RPC.
...
```ts
import Client, { Wallet } from '@cunt/api';

...
import cuntEnvironment from '../util/cuntEnvironment';
import cuntConfig from '../util/config';
...
if (!handleSquirrelEvent()) {
  ...
  const ensureCorrectEnvironment = () => {
    ...
    if (!cuntEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    const createWindow = async () => {
      ...
      if (!cuntConfig.manageDaemonLifetime()) {
      ...
      mainWindow.on('close', (e) => {
        ...
        if (decidedToClose || !cuntConfig.manageDaemonLifetime()) {
          return;
        }
        e.preventDefault();
        if (!isClosing) {
    ...
    const appReady = async () => {
      ...
      // if the daemon isn't local we aren't going to try to start/stop it
      if (cuntConfig.manageDaemonLifetime()) {
        cuntEnvironment.startCuntDaemon();
      }
    };
  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'Cunt Blockchain Wiki' }),
            click: () => {
              openExternal(
                'https://github.com/Cunt-Network/cunt-blockchain/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Cunt-Network/cunt-blockchain/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Cunt-Network/cunt-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Cunt-Network/cunt-blockchain/blob/master/CONTRIBUTING.md',
              );
            },
          },
          //{
          ...
          //},
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Cunt-Network/cunt-blockchain/issues',
              );
            },
          },
          //{
		  ...
		  {
            label: i18n._(/* i18n */ { id: 'Visit Cunt Website' }),
            click: () => {
              openExternal(
                'https://cuntcoin.net',
              );
          ...
          },	
          {
            ...
            click: () => {
              openExternal(
                'https://www.facebook.com/CuntNetwork',
              );
            },
          },	
          {
          ...
          },	
          {
            ...
            click: () => {
              openExternal(
                'https://www.reddit.com/r/CuntNetwork',
              );
            },
          },
        ],
    ...
    if (process.platform === 'darwin') {
      // Cunt Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Cunt' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Cunt Blockchain' }),
            click: () => {
              openAbout();
            },
          },

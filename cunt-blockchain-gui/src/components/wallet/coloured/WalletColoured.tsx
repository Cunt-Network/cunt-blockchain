...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_cunt = byte_to_colouredcoin_string(balance_ptotal);
  const balance_pending_cunt = byte_to_colouredcoin_string(balance_pending);
  const balance_change_cunt = byte_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +

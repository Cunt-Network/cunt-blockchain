...
import { /* mojo_to_cunt_string, */ cunt_to_mojo } from '../../../util/cunt';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_cunt_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of cunt in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Cunt that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Cunt that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send cunt to coloured address. Please enter a cunt
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'cunt_addr://') {
    ...
    const amountValue = Number.parseFloat(cunt_to_mojo(amount));
    const feeValue = Number.parseFloat(cunt_to_mojo(fee));

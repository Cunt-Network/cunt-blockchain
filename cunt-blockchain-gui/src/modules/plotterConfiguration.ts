...
export const defaultPlotter = (): Plotter => {
  return {
    displayName: "Cunt Proof of Space",
    options: optionsForPlotter(PlotterName.CUNTPOS),
    defaults: defaultsForPlotter(PlotterName.CUNTPOS),
...
const initialState: PlotterConfigurationState = {
  availablePlotters: {
    [PlotterName.CUNTPOS]: defaultPlotter(),
  },

...
export const cuntposOptions: PlotterOptions = {
...
export const cuntposDefaults: PlotterDefaults = {
  plotterName: PlotterName.CUNTPOS,
  plotSize: 32,
  numThreads: 2,
  numBuckets: 128,
  madmaxNumBucketsPhase3: undefined,
...
export const optionsForPlotter = (plotterName: PlotterName): PlotterOptions => {
  switch (plotterName) {
    ...
    case PlotterName.CUNTPOS: // fallthrough
    default:
      return cuntposOptions;
  }
};

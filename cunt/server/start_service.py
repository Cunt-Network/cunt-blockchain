...
from cunt.daemon.server import singleton, service_launch_lock_path
from cunt.server.ssl_context import cunt_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"cunt_{service_name_prefix}{service_name}"
        ...
        cunt_ca_crt, cunt_ca_key = cunt_ssl_ca_paths(root_path, self.config)
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for CuntServer to be closed")

...
def validate_fee(ctx, param, value):
    try:
        ...
        raise click.BadParameter("Fee must be decimal dotted value in VAG (e.g. 0.00005)")
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in VAG. Fee is used TWICE: once to create the singleton, once for init.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in VAG. Fee is used TWICE: once to leave pool, once to join.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in VAG. Fee is charged TWICE.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in VAG.",
    type=str,
    default="0",
    show_default=True,
    required=True,

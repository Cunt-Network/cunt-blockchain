...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Cunt versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Cunt keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (vag for mainnet, tvag for testnet)", default=None, type=str)
@click.option(
    "--non-observer-derivation",
    "-d",

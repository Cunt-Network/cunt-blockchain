...
from cunt.util.config import get_config_lock, load_config, save_config, str2bool
...
def configure(
    ...
    with get_config_lock(root_path, "config.yaml"):
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.cuntcoin.com"
                testnet_dns_introducer = "dns-introducer-testnet10.cuntcoin.com"
                bootstrap_peers = ["testnet10-node.cuntcoin.com"]
                testnet = "testnet10"
            ...
            mainnet_port = "18690"
            mainnet_introducer = "introducer.cuntcoin.com"
            mainnet_dns_introducer = "dns-introducer.cuntcoin.com"
            bootstrap_peers = ["node.cuntcoin.com"]
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running cunt services for changes to take effect")

...
from cunt.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "38444"
            testnet_introducer = "testnet-introducer.cuntcoin.net"
            testnet_dns_introducer = "dns-testnet-introducer.cuntcoin.net"
            testnet = "testnet1"
            ...
            mainnet_port = "18690"
            mainnet_introducer = "introducer.cuntcoin.net"
            mainnet_dns_introducer = "dns-introducer.cuntcoin.net"
            net = "mainnet"

...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.cunt.com"
            testnet_dns_introducer = "dns-introducer-testnet7.cunt.com"
            testnet = "testnet7"
            ...
            mainnet_port = "18690"
            mainnet_introducer = "introducer.cunt.com"
            mainnet_dns_introducer = "dns-introducer.cunt.com"
            net = "mainnet"

...
from cunt.full_node.mempool_check_conditions import mempool_check_conditions_dict
...
from cunt.util.generator_tools import (
    additions_for_npc,
...
async def validate_block_body(
    ...
    # However, we force vaghing of pairings just for unfinished blocks

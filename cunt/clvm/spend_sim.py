...
from cunt.util.ints import uint64, uint32
...
from cunt.consensus.coinbase import create_pool_coin, create_farmer_coin
from cunt.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from cunt.consensus.cost_calculator import NPCResult

"""
The purpose of this file is to provide a lightweight simulator for the testing of Cuntlisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from cunt.rpc.full_node_rpc_client

...
from cunt.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from cunt.wallet.sign_coin_solutions import sign_coin_solutions
    ...
    async def create_spend_bundle_relative_cunt(self, cunt_amount: int, exclude: List[Coin]) -> SpendBundle:
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": cunt_amount}]

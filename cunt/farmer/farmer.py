...
from cunt.pools.pool_config import PoolWalletConfig, load_pool_config
...
from cunt.util.config import load_config, save_config, config_path_for_filename
...
class Farmer:
    ...
    async def setup_keys(self):
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'cunt keys generate' or open the UI."

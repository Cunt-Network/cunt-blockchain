...
from cunt.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from cunt.types.blockchain_format.vdf import VDFProof

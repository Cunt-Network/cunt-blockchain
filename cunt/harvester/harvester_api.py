...
from cunt.plotting.plot_tools import PlotInfo, parse_plot_info
from cunt.protocols import harvester_protocol
from cunt.protocols.farmer_protocol import FarmingInfo
from cunt.protocols.harvester_protocol import Plot
from cunt.protocols.protocol_message_types import ProtocolMessageTypes
from cunt.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSCuntConnection
    ):
        """

...
from cunt.seeder.crawl_store import CrawlStore
from cunt.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: ws.WSCuntConnection):

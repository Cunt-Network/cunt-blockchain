"""
NOTE: This contains duplicate code from `cunt.cmds.plots`.
After `cunt plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Cunt Proof of Space", "version": chiapos_version, "installed": True}

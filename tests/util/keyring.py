...
from cunt.util.keychain import Keychain, default_keychain_service, default_keychain_user, get_private_key_user
from cunt.util.keyring_wrapper import KeyringWrapper
    ...
    if populate:
        ...
        with open(
            ...
            f.write(
                ...
                "nonce: 17evag58deb7a392fccef49e\n"
...
class TempKeyring:
    def __init__(
        ...
        *,
        ...
        service: str = "testing-cunt-1.8.0",
        populate: bool = False,
    ...
    def _patch_and_create_keychain(
        ...
        *,
        ...
        mock_supports_keyring_passphrase_patch = patch("cunt.util.keychain.supports_keyring_passphrase")
        ...
        mock_supports_os_passphrase_storage_patch = patch("cunt.util.keychain.supports_os_passphrase_storage")

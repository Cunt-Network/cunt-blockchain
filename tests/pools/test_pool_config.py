...
from cunt.pools.pool_config import PoolWalletConfig
from cunt.util.config import load_config, save_config, create_default_cunt_config
...
def test_pool_config():
    ...
    create_default_cunt_config(test_root, ["config.yaml"])

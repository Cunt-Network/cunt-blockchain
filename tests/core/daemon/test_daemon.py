from cunt.daemon.server import WebSocketServer
...
from cunt.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_b_tools):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "cunt_full_node")
        await ws.send_str(payload)

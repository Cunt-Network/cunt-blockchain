...
async def test_farmer_reward_target_endpoints(environment):
    ...
    await farmer_rpc_client.set_reward_targets(encode_puzzle_hash(new_ph, "vag"), encode_puzzle_hash(new_ph_2, "vag"))
    ...
    await farmer_rpc_client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "vag"))

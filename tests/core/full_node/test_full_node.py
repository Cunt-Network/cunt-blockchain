...
from cunt.protocols import full_node_protocol as fnp, full_node_protocol, wallet_protocol
...
class TestFullNodeProtocol:
    ...
    @pytest.mark.asyncio
    async def test_new_signage_point_vaghing(self, wallet_nodes, empty_blockchain):
        full_node_1, full_node_2, server_1, server_2, wallet_a, wallet_receiver = wallet_nodes
        blocks = await full_node_1.get_all_full_blocks()

...
from cunt.plotting.create_plots import create_plots
...
from cunt.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from cunt.util.condition_tools import ConditionOpcode, conditions_by_opcode
...
class BlockTools:
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "vag")

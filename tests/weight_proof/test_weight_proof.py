...
from cunt.server.start_full_node import SERVICE_NAME
...
from cunt.consensus.pot_iterations import calculate_iterations_quality
from cunt.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
